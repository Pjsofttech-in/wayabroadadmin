...
const navItems = [
  { label: "Registration Form", to: "/wayabroadadmin/admin/registration" },
  { label: "Registration List", to: "/wayabroadadmin/admin/registration/list" },
  { label: "Generate QR Code", to: "/wayabroadadmin/admin/registration/qr" },
];
