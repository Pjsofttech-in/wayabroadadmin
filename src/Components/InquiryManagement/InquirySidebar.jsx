...
const navItems = [
  ...
  { label: "QR Code", to: "/wayabroadadmin/admin/abroadinquiry/qr-code" },
];
...
const InquirySidebar = () => {
  ...
  const filteredNavItems = navItems.filter((item) => {
    // Hide specific items for superAdmin
    if (role === "superAdmin") {
      return !["Add inquiry", "To Do List", "FeedBack", "Lead Settings", "QR Code"].includes(item.label);
    }
    
    // For other roles, show all items except those explicitly hidden
    return true;
  });
